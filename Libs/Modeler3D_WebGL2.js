...
function Modeler3D(verticies, onSubmit)
{
    ...
    {
        SubWindowHelper.alert("WebGL 2", "Oh, no! Your browser does not support WebGL 2. Please try a different browser (or if using WebKit, try to use this program again later).");
    ...
    {
        gl.uniformMatrix4fv(worldMatrixUniformLocation, true, worldMatrix.getArray());
    ...
    var updateMatricies = function()
    {
        // DO transpose.
        updateWorldMatrix();
        gl.uniformMatrix4fv(viewMatrixUniformLocation, true, viewMatrix.getArray());
        gl.uniformMatrix4fv(cameraMatrixUniformLocation, true, cameraMatrix.getArray());
    };
